...
A marketing landing page for the Dosa Hut Sunshine Coast branch (5 Lutana
Street, Buddina). It introduces the restaurant, showcases the menu and
...
Journey: Dosa Hut main site → Queensland → Sunshine Coast → this page →
...
| --- | --- | --- |
| `NEXT_PUBLIC_SITE_URL` | Canonical origin for `metadataBase`, the `<link rel="canonical">` tag, Open Graph URLs and the `Restaurant` JSON-LD | `https://sunshinecoast.dosahut.net.au` |
