...
await db.exec(`
  CREATE TABLE IF NOT EXISTS vip_members (
      ...
      first_branch  VARCHAR(100) DEFAULT 'sunshine_coast',
      home_branch   VARCHAR(100) DEFAULT 'sunshine_coast',
      last_branch   VARCHAR(100) DEFAULT 'sunshine_coast',
      last_seen_at  BIGINT,
...
await db.exec(`
  ...
  VALUES ('+61400000001', 'sunshine_coast', 3);
`);
